function tempModel2 = add_atom_sizes(tempModel2)
...
all_res_names = {'Ala', 'Ile', 'Leu', 'Phe', 'Val', 'His', 'Gln', 'Arg', 'Trp', 'Asp', 'Asn', 'Cys', 'Met', 'Ser', 'Thr', 'Tyr', 'Glu', 'Lys', 'Pro', 'Gly'};
for amino_acids = 1:20
    ...
    for i = 1:size(res_atoms, 2)
        ...
        tempModel2(cell2mat(all_this_res(ind0,1)),7) = num2cell(Atom_sizes(i));
    end
    
end
ind0 = ismember(tempModel2(:,2), {'H1', 'H2' ,'H3'});
tempModel2(ind0,7) = {1.1};

ind0 = ismember(tempModel2(:,2), {'OXT'});
tempModel2(ind0,7) = {1.3};
end